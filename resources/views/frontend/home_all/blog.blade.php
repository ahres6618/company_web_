                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                ...
                                <span class="post__by">By : <a href="#">{{$post->blog_title}}</a></span>
                            </div>
                            <h2 class="title"><a href="blog-details.html">{{$post->blog_title}}</a></h2>
                            <p>{{Str::limit($post->blog_description, 20);}}</p>
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{Carbon\Carbon::parse($post->created_at)->diffForhumans()}}</li>
                                <li><i class="fal fa-comments-alt"></i> <a href="#"></a></li>
                                <li class="post-share"><a href="#"><i class="fal fa-share-all"></i> </a></li>
                            </ul>
                        </div>
                    </div>
                    @endforeach
