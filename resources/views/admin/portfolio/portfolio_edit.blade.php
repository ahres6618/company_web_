            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Home Edit edit</h4>
                    <form method="post" action="{{route('potfolio.update')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea required="" class="form-control" rows="5" name="portfolio_description">{{$portfolio->portfolio_title}}</textarea>
                            </div>
                        </div>
